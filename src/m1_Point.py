...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        self.distance_traveled = self.distance_traveled + math.sqrt(((self.startx - x) ** 2) + ((self.starty - y) ** 2))
    ...
    def get_distance_from_start(self):
        self.distance_start = math.sqrt(((self.x - self.startx) ** 2) + ((self.y - self.starty) ** 2))
    ...
    def closer_to(self, p2, p3):
        distance2 = math.sqrt(((p2.x - self.x) ** 2) + ((p2.y - self.y) ** 2))
        distance3 = math.sqrt(((p3.x - self.x) ** 2) + ((p3.y - self.y) ** 2))
    ...
    def halfway_to(self, p2):
        halfway = ((p2.x + self.x) / 2, (p2.y + self.y) / 2)
        return halfway
...
def run_test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    # DONW: 8.  Follow the same instructions as in TO-DO 3 above,
